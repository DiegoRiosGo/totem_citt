 ...
 * @author jaria
 */
public class Primeros_auxilios extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Primeros_auxilios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
