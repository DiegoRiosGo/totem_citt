 ...
 * @author jaria
 */
public class Panol_mecanica extends javax.swing.JFrame {

    /**
     * Creates new form Piso_3
     */
    public Panol_mecanica() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Panol_mecanica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
