 ...
 * @author jaria
 */
public class Sala_profesores extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sala_profesores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
